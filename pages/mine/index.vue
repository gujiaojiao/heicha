      ...
      <view class="content-wrapper">
        ...
        <view class="member-card" v-if="memberInfo">
          ...
          <view class="member-card__body">
            ...
            <view class="growth" style="
              display: flex;
              justify-content: space-between;
              padding-top: 20rpx;
            ">
              <text class="growth-text">成长值：{{ memberInfo.growth.current }}/{{
                            memberInfo.growth.total
                        }}</text>
              <text class="next-level">还差{{
                            memberInfo.growth.total - memberInfo.growth.current
                        }}成长值升级为{{ memberInfo.nextLevel }}</text>
            </view>
            ...
            <view class="progress-box">
              <progress :percent="(memberInfo.growth.current / memberInfo.growth.total) * 100
                            " stroke-width="4" activeColor="#fff" backgroundColor="rgba(255, 255, 255, 0.3)" active="true" border-radius="16rpx" />
            </view>
          </view>
        </view>
        ...
        <view class="member-benefits">
          ...
          <view class="benefits-grid">
            <view class="benefit-item" v-for="benefit in memberBenefits" :key="benefit.id" @tap="navigateTo(benefit.link)">
        ...
        <view class="mine-functions">
          ...
          <view class="functions-grid">
            <view class="function-item" v-for="func in mineFunctions" :key="func.id" @tap="navigateTo(func.link)">
